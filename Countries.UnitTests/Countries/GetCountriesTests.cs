...
namespace Countries.UnitTests.Countries;
...
public class GetCountriesTests
{
    ...
    [Fact]
    public async Task
        WhenGetCountriesReceivesNullPagingParametersAndGetAllAsyncMethodReturnsCountries_ShouldFillUpDefaultPagingParametersAndReturnCountries()
    {
        // Arrange
        int? pageIndex = null;
        int? pageSize = null;
        ...
        // Act
        var result =
            await CountryEndpoints.GetCountries(pageIndex, pageSize, _countryMapper, _countryService) as
                Ok<List<Country>>;
